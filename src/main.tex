...
\textbf{Want to see our actions?} \\ \checkmark Visit https:\slash \slash actions.docs.ansys.com for more information. \\ \newline \textbf{Have questions?} \\ \checkmark Don't be shy and start the conversation!
}
% Smartphone icon
% Author: Freepik
...
Guarantees the creation of components and artifacts for efficient software distribution. Verifies
that the artifacts include the proper metadata.

\section{\includegraphics[height=\fontcharht\font`\S]{img/general/slash.png} Release}
Distributes pre-built components and artifacts to expedite software development,
