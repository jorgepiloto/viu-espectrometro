...
\section{\includegraphics[height=\fontcharht\font`\S]{img/general/slash.png} 1. Entrada de luz}
...
luz que se analizará y asegura que la fuente de luz sea coherente.

\section{\includegraphics[height=\fontcharht\font`\S]{img/general/slash.png} 2. Collimación}
...
\section{\includegraphics[height=\fontcharht\font`\S]{img/general/slash.png} 3. Reducción de la luz dispersa}
Para eliminar la luz dispersa y mejorar la calidad del espectro, se utiliza un
colimador adicional. Esto garantiza que la luz que llega al siguiente paso sea
lo más paralela posible.
...
\section{\includegraphics[height=\fontcharht\font`\S]{img/general/slash.png} 5. Detección}
...
\section{\includegraphics[height=\fontcharht\font`\S]{img/general/slash.png} 6. Análisis de datos}
